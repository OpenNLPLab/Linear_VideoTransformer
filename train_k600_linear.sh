...
python tools/slurmRunNet.py \
  --cfg configs/Kinetics/lxvitv2_B16_16x16_k600_21k_cgate_tempshift_spatialshift.yaml --port 21235 \
  DATA.PATH_TO_DATA_DIR /mnt/lustre/share_data/liuzexiang/Data/k600/ \
